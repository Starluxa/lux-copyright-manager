...
function lcm_enqueue_admin_assets( $hook ) {
	if ( 'settings_page_lux-copyright' !== $hook ) {
		return;
	}
	wp_enqueue_style(
		'lux-copyright-manager-admin-styles',
		plugin_dir_url( __FILE__ ) . 'build/style-index.css',
		array(),
		filemtime( plugin_dir_path( __FILE__ ) . 'build/style-index.css' )
	);
	wp_enqueue_script(
		'lux-copyright-manager-admin-script',
		plugin_dir_url( __FILE__ ) . 'includes/admin-script.js',
		array( 'jquery' ),
		filemtime( plugin_dir_path( __FILE__ ) . 'includes/admin-script.js' ),
		true
	);
	wp_localize_script( 'lux-copyright-manager-admin-script', 'luxCopyrightData', array(
